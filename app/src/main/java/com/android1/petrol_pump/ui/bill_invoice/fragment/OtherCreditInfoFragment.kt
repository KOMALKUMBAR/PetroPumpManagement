 ...
 * Use the [OtherCreditInfoFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class OtherCreditInfoFragment : Fragment(), AdapterCallbackInterface {
    ...
    override fun onCreateView(
        ...
        val viewOCI = inflater.inflate(R.layout.fragment_other_credit_info, container, false)
        // Inflate the layout for this fragment
        val recyclerView: RecyclerView = viewOCI.findViewById(R.id.recyclerViewPdInfo)
        buttonAddItem = viewOCI.findViewById(R.id.button_add)

        val adapter = OtherCreditInfoAdapter(this)
        recyclerView.adapter = adapter
        recyclerView.layoutManager = LinearLayoutManager(context)

        val formData = OtherCreditInfoFormData("","","")
    ...
    companion object {
         ...
         * @return A new instance of fragment OtherCreditInfoFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            OtherCreditInfoFragment().apply {
